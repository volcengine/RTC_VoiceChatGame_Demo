...
@interface GameRoomAvatarComponents ()
...
@implementation GameRoomAvatarComponents
...
- (void)setFontSize:(NSInteger)fontSize {
    ...
    self.avatarLabel.font = [UIFont systemFontOfSize:fontSize weight:UIFontWeightSemibold];
}
