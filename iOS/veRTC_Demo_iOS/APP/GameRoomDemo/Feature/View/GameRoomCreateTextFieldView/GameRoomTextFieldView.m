...
@interface GameRoomTextFieldView ()
...
@implementation GameRoomTextFieldView
...
- (BaseButton *)cancelButton {
    if (!_cancelButton) {
        ...
        [_cancelButton setImage:[UIImage imageNamed:@"menu_user_name" bundleName:HomeBundleName] forState:UIControlStateNormal];
