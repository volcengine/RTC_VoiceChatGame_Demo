...
@interface GameRoomAudienceListsView ()<UITableViewDelegate, UITableViewDataSource, GameRoomUserListtCellDelegate>
...
@implementation GameRoomAudienceListsView
...
- (void)gameRoomUserListCell:(GameRoomUserListCell *)gameRoomAudienceListsView clickButton:(id)model {
    if ([self.delegate respondsToSelector:@selector(gameRoomAudienceListsView:clickButton:)]) {
        [self.delegate gameRoomAudienceListsView:self clickButton:model];
    }
}
