...
@interface GameRoomUserListCell ()
...
@implementation GameRoomUserListCell
...
- (void)rightButtonAction:(BaseButton *)sender {
    if ([self.delegate respondsToSelector:@selector(gameRoomUserListCell:clickButton:)]) {
        [self.delegate gameRoomUserListCell:self clickButton:self.model];
    }
}
