...
@interface GameRoomParamInfoView ()

@property (nonatomic, strong) NSMutableArray<UILabel *> *viewLists;

@end

@implementation GameRoomParamInfoView
...
- (void)setParamInfoModel:(GameRoomParamInfoModel *)paramInfoModel {
...
- (void)getMeessageWithModel:(GameRoomParamInfoModel *)paramInfoModel index:(NSInteger)index label:(UILabel *)label {
    NSString *title = @"";
    NSString *str = @"";
    switch (index) {
        case 0:
